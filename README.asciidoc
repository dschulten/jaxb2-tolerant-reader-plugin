...
Schemas which use version numbers in namespaces are a particular challenge. See <<packageRoot>> for possibilities to avoid versioned package names for your beans.
