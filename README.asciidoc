...
In order to support two versions at once, we use Eclipselink Moxy during marshalling. Run the maven build and look at the _target/it/xfinanz/build.log_ to see the xml result.
