...
Each version of a schema with versioned `targetNamespace` requires you to generate a different set of JAXB beans, i.e. your client still speaks only one version of the schema.
...
* https://www.subbu.org/blog/2005/03/xml-versioning-vs-extensibility[XML Versioning vs Extensibility]
* https://www.subbu.org/blog/2005/03/versioning-xml-schemas[Versioning XML Schemas]
* https://www.subbu.org/blog/2005/03/processing-versioned-xml-documents[Processing Versioned XML Documents]
